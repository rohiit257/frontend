...
export const metadata: Metadata = {
  title: 'Yalla Makhana LLC | Flavored Foxnut Snacks',
...
export default function YallaMakhanaPage() {
  return (
    <BusinessPage
      title="Yalla Makhana LLC"
      subtitle="Flavored Makhana Snacks"
      description="Yalla Makhana LLC is a UAE-facing packaged snack brand centered on foxnuts, offering a flavor-forward portfolio designed for modern retail shelves, grocery channels, and direct consumer discovery."
      features={[
