...
function getFallbackReviews() {
  return [
    ...
    },
    {
      ...
      profilePhoto: null,
      rating: 5,
      text: 'Wings9 Properties LLC made our real estate investment journey seamless. Professional team with deep market knowledge. They found us the perfect commercial property in Dubai Marina within our budget. Exceptional service from start to finish.',
    ...
    },
    {
      ...
      profilePhoto: null,
      rating: 5,
      text: 'Working with Wings9 Consultancies LLC was a game-changer for our export business. Their expertise in international trade regulations and market entry strategies helped us establish presence in 3 new countries. Truly professional and results-driven.',
    ...
    },
    {
      ...
      profilePhoto: null,
      rating: 4,
      text: 'Wings9 Technologies LLC delivered an excellent web platform for our e-commerce business. The team understood our requirements well and delivered on time. Minor delays in communication but overall great experience.',
      relativeTime: '1 month ago',
      timestamp: Date.now() - 30 * 24 * 60 * 60 * 1000,
    },
  ];
